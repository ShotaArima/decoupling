...
4変数への分解や centering constraint が必要である。
```
...
この結果により、2-Exp-11 / 2-Exp-22 で示した 4変数への分解の重要性が強まる。2-Exp-27 は「latent split だけでは足りない」という bridge / negative result として扱う。
